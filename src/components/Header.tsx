...
//   const { data } = useGetAllAppointmentsQuery(undefined);
//   const { data: userProfile } = useUserProfileQuery(undefined);

//   const IMAGE_BASE_URL = process.env.NEXT_PUBLIC_API_KEY || 'http://115.127.156.13:3005';
...
//   return (
//     <header
//       className={`sticky top-0 z-40 bg p-4 text-white ${
//         pathname == "/lo" ? "" : ""
//       }`}
//     >
...
const Header = () => {
  ...
  const IMAGE_BASE_URL = process.env.NEXT_PUBLIC_API_KEY || 'http://115.127.156.13:3005';
  console.log("IMAGE_BASE_URL:", IMAGE_BASE_URL); // Debugging Log
