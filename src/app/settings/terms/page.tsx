"use client";
import {  useTermsGetQuery } from "@/redux/features/setting/SettingSlice";
...
const AboutUs = () => {
  ...
  const { data, isLoading, error } = useTermsGetQuery(undefined);
  console.log(data);
  ...
  return (
    <div className="flex flex-col justify-between p-4 text-black">
      <h1 className="text-3xl font-semibold mb-6">Terms & Condition</h1>
      <div className="space-y-4">
        <p className="text-gray-600">{privacyDescription}</p>
      </div>
      <div className="flex justify-end pt-10">
        <Button
          onClick={() => router.push("/settings/terms/edit")}
          style={{
